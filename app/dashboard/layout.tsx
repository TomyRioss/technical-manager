    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="border-b border-border bg-white">
        ...
        {!pathname.startsWith('/dashboard/pos') && <nav className="flex items-center gap-0 px-3 sm:px-6 overflow-x-auto">
          ...
          <div className="mx-1 h-4 w-px bg-neutral-200 self-center" />
          <Link
            href="/ayuda"
            className="flex items-center gap-0 sm:gap-1.5 border-b-2 border-transparent px-2.5 sm:px-4 py-2 text-xs sm:text-sm font-medium text-neutral-400 hover:text-neutral-600 transition-colors"
          >
